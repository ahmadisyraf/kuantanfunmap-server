import { pgTable, text, timestamp, unique, integer, varchar, doublePrecision, jsonb, boolean, foreignKey } from "drizzle-orm/pg-core"
...
export const place = pgTable("place", {
	...
	unique("place_name_unique").on(table.name),
]);
